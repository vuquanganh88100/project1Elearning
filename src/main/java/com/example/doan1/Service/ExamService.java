...
ExamRepository examRepository;
    ...
    public Integer countExamsByQuizId(Integer quizId){
        Integer examEntity =examRepository.countExamsByQuizId(quizId);
        return  examEntity;
    }
    public List<ExamDto> getExamsByQuizId(Integer quizId) {
        List<ExamEntity> examEntities = examRepository.findByQuizId(quizId);
